...
<nav class="navbar navbar-expand-md navbar-light shadow-sm mb-3" style="background-color: #a1f09f">
    ...
    <div class="container fs-4 text-success">
    <form class="ms-4" action="{{ route('admin.brands.update', $brand) }}" method="post" enctype="multipart/form-data">
        @method('put')
        @csrf
        ...
        <div class="form-group mb-2">
            ...
            <label class="text-dark" for="ethical_yes">Yes</label>
            <input type="radio" name="ethical" id="ethical_no" value="no">
            <label class="text-dark" for="ethical_no">No</label>
        ...
        <button type="submit" class="fs-5 btn btn-success my-2">Save Changes</button>
    </form>
</div>
@endsection
